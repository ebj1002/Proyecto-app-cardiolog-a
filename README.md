...
Nayara López de Armentia

Adriana Wöllecke Garrastacho
## Metodología
La planificación de este proyecto se estructura bajo un marco de trabajo ágil, dividiendo la carga operativa en ciclos de tiempo cerrados (Sprints) para garantizar la trazabilidad de los requisitos clínicos y el diseño de la interfaz.
